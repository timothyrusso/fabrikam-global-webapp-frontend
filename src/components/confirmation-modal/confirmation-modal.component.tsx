...
export const ConfirmationModalComponent: FC<ConfirmationModalComponentProps> = ({ handleDeleteConfirmation }) => {
    ...
    return (
      <>
        <IconButton aria-label="Remove user" icon={<DeleteIcon />} onClick={onOpen} />
        ...
        <Modal isOpen={isOpen} onClose={onClose} isCentered>
          ...
          <ModalContent>
            ...
            <ModalFooter>
              <Button colorScheme='blue' mr={3} w={50} onClick={handleDeleteConfirmation}>
                Si
              </Button>
              <Button w={50} onClick={onClose}>No</Button>
            </ModalFooter>
          </ModalContent>
        </Modal>
      </>
